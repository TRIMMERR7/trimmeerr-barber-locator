...
const SocialAuthButtons = ({ onGoogleAuth, onAppleAuth }: SocialAuthButtonsProps) => {
  return (
    <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20 space-y-3">
      ...
      <Button 
        type="button"
        onClick={onAppleAuth}
        className="w-full h-12 text-base bg-black/40 hover:bg-black/60 text-white rounded-xl font-semibold backdrop-blur-sm border border-white/20"
      >
